...
function scrollToTarget(D)
{
	...
	{
		D = document.getElementById("bloc-2").scrollIntoView();
		// D = document.getElementById("bloc-2").scrollIntoView(true);
	}
	else if(D == 4)
	{
		D = document.getElementById("bloc-3").scrollIntoView();
		// D = document.getElementById("bloc-2").scrollIntoView(true);
	}
	else if(D == 5)
	{
		D = document.getElementById("bloc-4").scrollIntoView();
		// D = document.getElementById("bloc-2").scrollIntoView(true);
	}
	else if(D == 6)
	{
		D = document.getElementById("bloc-5").scrollIntoView();
		// D = document.getElementById("bloc-2").scrollIntoView(true);
	}
	else // Specific Bloc
	{
